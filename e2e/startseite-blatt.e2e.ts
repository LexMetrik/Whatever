...
// Nachtrag W2·31-BILDSCHIRMBREITE (25.9.2026): seit die Startseite auf `weit`
// steht, gilt die Breiten-Prämisse oben nur noch bis 1535 px — ab `2xl` ist das
// Blatt 1032 statt 712 px breit. Die breiten Fälle (@1536×864, @1680×1050,
// @1920×1080, @1536 mit Seitenleiste) prüft `e2e/startseite-breite.e2e.ts` (3).
