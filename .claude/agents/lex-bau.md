...
TESTS: Randdaten abseits des Glücksfalls (Datum ≠ Monatserster); ein neues Eingabefeld in ALLE Konsumenten (Rechner + Vorlagen) verdrahten und je testen — beides maskierten die Tests in RL-16b (25.9.2026), erst die Gegenprüfung fand es.
