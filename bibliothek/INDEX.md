...
(BGG, SGG, VGG u. a.), FR gleich, IT 30→20. **Berichtigt am 21.9.2026 (zweite Runde, Datei Ziff. 1a):**
hier stand, 08.053 liefere «12 Zeilen, 8 distinkt», und das seien echte Duplikate — gemessen war das
nur mit dem Sechs-Feld-Schlüssel, der Zeilen zusammenfasst, die sich in der **Vorlage** (`BillNumber`)
unterscheiden. Der Vollzensus aller 14 669 DE-Objective-Zeilen zeigt an 08.053 zwölf verschiedene
Zeilen (03.047: 17 statt 14); seit `publikationen[].vorlage` führt der Generator sie getrennt.
Echte Doppellieferungen gibt es korpusweit trotzdem — vier Zeilen an 22.417, 26.023, 19.464, keines
dieser Geschäfte mit Shard —, der Dedupe bleibt darum. Dazu zwei Beschriftungs-Regeln:
`publikationen[].datum` ist Fedlex `jolux:dateDocument`, **nicht**
...
Fällen danach aber wirklich «keine Schlussabstimmung». Tor `check:entstehung` (Kreuzprobe gegen die
ROHE amtliche Zeilenzahl — die frühere Gegenzählung teilte die Identitäts-Entscheidung des
Schlüssels und konnte dessen Fehler darum nicht finden). Gegenprüfung läuft; fachliche Abnahme David offen.
...
| Dokument | Inhalt |
|---|---|
| [pflegetermin-2026-10-01-sparql-gegenprobe.md](register/pflegetermin-2026-10-01-sparql-gegenprobe.md) | **Pflegetermin 1.10.2026 — amtliche SPARQL-Gegenprobe** (20.9.2026, `QS-MONITOR-ROT`): alle 18 Bund-Erlasse aus `parameter-verfall.md:68–85` einzeln gegen den Fedlex-SPARQL-Endpunkt (`jolux:dateApplicability`) abgefragt — 18/18 belegt, kein Drift; VRV/BBV tragen je eine weitere künftige Fassung nach dem 1.10. `check:verfall`/`check:fedlex-versionen` sind wanduhr-abhängig, erste automatische Rot-Meldung frühestens Mo 5.10.2026. Register-Abgleich 21.9.2026 bestätigt Anzahl + SR-Nummern unverändert | Momentaufnahme, Status entwurf |
...
| [zpo-stillstandsnaehe-a16-2026-09-25.md](normen/zpo-stillstandsnaehe-a16-2026-09-25.md) | A16 für ZPO (W-07): Fristende auf Sa/So/Feiertag vor dem Stillstand (Art. 142 Abs. 3 / 145 ZPO) — keine amtliche Klärung; Empfehlung Warnung wie RL-15/BGG (mittel) | ERSTRECHERCHE (25.9.2026) · Abnahme offen, Ausdehnung wartet auf David |
...
| [revisionen-auswirkungen-2026-09-23.md](normtext/revisionen-auswirkungen-2026-09-23.md) | **Änderungsliste aus der Fedlex-Rechtsanalyse «Auswirkungen»** (23.9.2026, W2·29-WERKBANK-LESER S6-D1, Befunde AE-2..AE-5): Quelle `LegalResourceImpact` (Quelle · Ziel-Teil am Abstract · Typ · Inkrafttreten · einarbeitende Fassung), Regel (nur das gepinnte Abstract, Etappen, Stammerlass nie, Pfad (b) nur im Geltungsfenster, Beschluss-/Artefakt-Daten, `datumAusErlass`), Messung vorher/nachher (Marker 1978→20, tote Links 1978→0, Deckung 1575→3899/3988), Pflegebedarf Fedlex-Datenfehler | Erstrecherche; Gegenprüfung ausstehend, fachliche Abnahme David offen |
| [werkzeug-kanten-2026-09-23.md](normtext/werkzeug-kanten-2026-09-23.md) | **Norm↔Werkzeug-Kanten suffix-exakt + Kanten-Revision** (23.9.2026, W2·29-WERKBANK-LESER S6-D6, Befunde AN-5/AN-6): Artikel-Kennung = Hauptnummer + Suffix-Folge, kein Vorsilben-Treffer (324 ≠ 324a), inklusive Bereiche in amtlicher Reihenfolge; Lohnfortzahlung an Art. 324a–324b OR statt 324, Nichtbekanntgabe an 8a SchKG statt 8, ArG ohne OR-Rechner (nur Überzeit Art. 12–13 ArG); 19 von 55 Paaren Erlass×Werkzeug geändert, Kanten 60 → 71; Fedlex AKN je geltende Fassung, Stichprobe 18/18. Offen: Funktionszeile (`randNotizWerkzeuge.ts`) vergleicht noch Hauptnummern. *Nachtrag 24.9.2026:* Nachzug erfolgt; Kanten 257d/257f OR (mietrecht) und 219a OR (gewaehrleistung) nachgetragen; Art. 273a–273c OR bewusst ohne Werkzeug (Engine führt sie nicht) — Zweifelsfall 273a wartet auf David; Skript-Liste aller herausfallenden Buchstaben-Artikel, Stichprobe 14/14 | Erstrecherche — Gegenprüfung ausstehend, Abnahme David offen |
...
- [Legal Design, Wizard-Korrektheit und rechtliche Bereitschaft — Recherche 21./22.9.2026](recherche/legal-design-und-korrektheits-recherche-2026-09-21.md) — vier rechtlich relevante Geister-Orte, fünfter §1-Ort Verjährung 2020, Curia-Variante C, BS-Lizenz geklärt, zehn David-Entscheide. ERSTRECHERCHE, keine Abnahme.
- [ESTV-Kreisschreiben: Dokumentdatum und Ersetzung — Messung 25.9.2026](materialien/estv-ks-dokumentdatum-und-ersetzung-2026-09-25.md) — Quelle ESTV-Indexseiten + KS-PDFs, Abruf 25.9.2026. Regel: Dokumentdatum aus der ersten Beschreibungszeile («vom DD.MM.YYYY»), nie aus dem Upload-Label, nie bei Beilagen (AN-2); W-Serie: Signatur aus dem Titel, Gegenstand aus der Beschreibung (AN-13). Ersetzung (AN-1) steht nur im PDF des Nachfolgers und uneinheitlich (KS 50 hebt 16 auf; 11a/18a ersetzen 11/18; 22a/23a ohne Klausel) — offen, fachlicher Entscheid David. Maschinell, nicht abgenommen.
