          ...
          <div className="p-4 space-y-4">
            ...
            {gueterstand === 'errungenschaftsbeteiligung' && (
              <div className={pk('grid grid-cols-1 sm:grid-cols-3 gap-4', 'grid grid-cols-1 @xl/pane:grid-cols-3 gap-4')}>
                ...
                <Field label="Vorschlag Erblasser (CHF)" hint="negativ = Rückschlag (mindert den Nachlass voll, Art. 210 Abs. 2)"><BetragsFeld erlaubeNegativ value={betraege.vorschlagE} onChange={(v) => setBetraege((b) => ({ ...b, vorschlagE: v }))} className={inputCls} /></Field>
