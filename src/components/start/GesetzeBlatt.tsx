...
// In S5b wieder zurückgenommen (§8-Wortlaut an David); seit S5c mit Davids Ja
// (25.9.2026, «wie empfohlen») gebaut — das Scope-Wort ist der Titel im
// selben Knopf, die zwei §8-Wächter prüfen es an der Kachel.
//
