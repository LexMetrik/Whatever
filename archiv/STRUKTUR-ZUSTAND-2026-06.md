# STRUKTUR.md — Zustands-Abschnitte Juni–August 2026 (archiviert)

*Archiviert 24.9.2026 (Bauplan-Konsolidierung M-22, `QS-DOKU-DIAET`). Der Wortlaut unten ist **unverändert** aus
`STRUKTUR.md` übernommen, Reihenfolge wie dort. Grund: jüngste Zeile je Abschnitt zwischen 5.6. und 14.8.2026
(`git blame`), der Ist-Zustand steht seit 22.9.2026 in `docs/INVENTAR-FUNKTIONEN.md` (#975) — zwei Beschreibungen
desselben Zustands wären eine zweite Wahrheit (§5). **Einzelinhalte wurden NICHT gegen den Code verifiziert**;
sie beschreiben den Stand ihres Datums (Belege altern nicht, §2b). In `STRUKTUR.md` bleibt je Abschnitt die
Überschrift mit einem Zeiger hierher.*
