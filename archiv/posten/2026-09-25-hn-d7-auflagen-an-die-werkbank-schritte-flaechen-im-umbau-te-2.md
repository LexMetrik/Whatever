...
titel: HN-D7 — Auflagen an die Werkbank-Schritte (Flächen im Umbau) (Teil LESER)
anlass: Herz-und-Nieren-Prüfung 24.9.2026, UMSETZUNGSPLAN HN-D7 (DK-24, DK-21, DK-26); Einbuchung: Go David 24.9.2026 («gleich die befunde einbaust»)
-->
...
- **An `W2·29-WERKBANK-LESER`:** DK-24 «Zitat»/«Link» in einer Form; Umzug der Ladeanzeige (`gesetz-leser/inhalt-ansichten.tsx:32, :136`); DK-26 Leser-Kopf auf dem Handy erst nach W-HN-3.
- Befunde: DK-24, DK-21, DK-26 (tief · EA).
