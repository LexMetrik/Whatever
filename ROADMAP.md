...
- [ ] **Normen-Monitor seit ≥5 Wochen rot — Wurzel-Fix** *(`QS-MONITOR-ROT`, Aktivierungs-Audit 14.8.2026)*
  ...
  - [ ] **Curia-Monatslauf 2026-09-19 = Entwurfs-PR #934** *(19.9.2026)* — wartet auf Gegenprüfung, Ablauf 1.10.2026.
  - [ ] **Nach Token-Tausch (David): Normen-Monitor per `workflow_dispatch` erneut fahren** *(19.9.2026)* — Nachweis «Curia-Job grün» steht nur deshalb aus; Token-Befund bereits unter `QS-BASIS`/#932 gebucht.
