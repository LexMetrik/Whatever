...
- [~] **Gesetz-Leser V3 — Hülle neu, Kern unangetastet** *(`W2·5m-LESER-V3`, Auftrag David 16.8.2026)*
  ...
  **Detail:** [FAHRPLAN-LESER-V3.md](fahrplaene/FAHRPLAN-LESER-V3.md) (Kurzfassung zuoberst; Kap. 7 Etappen H1–H5/S1–S4, Kap. 9 Fragen F1–F6).
  ...
  - [x] **Einzelartikel-Ansicht E1 + E2** *(Ansichtsoption, Auftrag David 14.9.2026; Konzept Kap. 15)* — ✅ erledigt 14.9.2026, PR #869: Umschalter «Ganzer Erlass | Einzelner Artikel», Blättern, Dossier-Blöcke Historie/Verweise/Materialien/Werkzeuge; die Nachbar-Pfeile aus #854 erscheinen nur noch hier (Davids Befund «das bringt aber nur etwas wenn man einzeln einen artikel hat»).
  - [ ] **Einzelartikel-Ansicht E3** *(Rest des Konzepts Kap. 15)* — offen. Ebenfalls offen: der **Rechtsprechung-Block im Dossier**, bewusst hinter `QS-CI-MINUTEN` M3 gestellt (die Shard-Umstellung berührt dieselben Specs).
