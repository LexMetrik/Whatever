...
- [ ] **Gesetz-Leser V3 — Hülle neu, Kern unangetastet** *(`W2·5m-LESER-V3`, Auftrag David 16.8.2026)*
  ...
  **Detail:** [FAHRPLAN-LESER-V3.md](fahrplaene/FAHRPLAN-LESER-V3.md) (Kurzfassung zuoberst; Kap. 7 Etappen H1–H5/S1–S4, Kap. 9 Fragen F1–F6).
  ...
  - [x] **S4 · Trefferreihenfolge** *(Begriffskollision 16.8. aufgelöst 15.9.2026, §5: die Kennung trägt nur noch die Fahrplan-Bedeutung)* — ✅ 16.8.2026 mit H2, PR #539 (`19a989f93`). Die **Kantons-Probe** war ein Nachweis, keine Etappe: erbracht 18.8.2026, PR #552 (H4-Bogen Ziff. 7, BS-640.100 + ZH-211.11, 0 Konsolenfehler). Wortlaut aller vier Posten + Ursachen-Analyse: ROADMAP-CHRONIK.md, Umschichtung 15.9.2026 (1).
  ...
  - [x] **Erledigt:** Nachbar-Artikel-Pfeile · Rohdaten-Link je Erlass — ✅ #854 (`7b0338916`), Wortlaut Umschichtung 14.9.2026 (4) · **Rohdaten-Zeiger ohne `fassungsToken`** (#854, Entscheid Agent C: §7 d verlangt Drift-**Erkennung**, keinen Hash-Abdruck im UI), Wortlaut Umschichtung 15.9.2026 (1) — beide ROADMAP-CHRONIK.md.
