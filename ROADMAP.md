...
- [~] **Werkbank-Umbau: Startseite neu gegliedert — Kacheln füllen die Fläche** *(`W2·29-WERKBANK-START-LAYOUT`, David 24.9.2026)*
  <!-- @meta id: W2·29-WERKBANK-START-LAYOUT · status: wip · blocker: null · dep: [W2·29-WERKBANK-START-FEINSCHLIFF] · feld: design · fahrplan: fahrplaene/FAHRPLAN-WERKBANK-UMBAU.md -->
