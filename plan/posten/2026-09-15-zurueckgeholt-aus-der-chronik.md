...
titel: Zurückgeholt aus der Chronik: Konflations-Wächter, Prerender «geltend», Tabellen-Marken, Sidecars ohne stand, suche.test.ts-Budget
anlass: Umschichtung 15.9.2026 (Entstehung); Nebenfund #896: offene Posten im Archiv sind für `plan:next` unsichtbar
-->
...
Titel nachgeschärft 24.9.2026 (vorher «Zurückgeholt aus der Chronik», nichtssagend; Bauplan-Konsolidierung M-19).
