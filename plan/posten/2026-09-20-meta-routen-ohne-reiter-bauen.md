...
titel: Meta-Routen OHNE Reiter bauen
-->
...
Umgehängt 24.9.2026 (W2·18-FEHLERBUCH → W2·29-WERKBANK-REST, Bündelung in den Werkbank-Umbau, Auftrag David 24.9. «was das Gleiche oder Ähnliches betrifft, auch in diesen Umbau»): S3 (statische Seiten); neue Funktion (Entscheid David 19.9.), fasst die Reiterleiste an.
