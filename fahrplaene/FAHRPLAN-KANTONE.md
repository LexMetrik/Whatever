...
**A · aus `W2·13-KANTONE` (Darstellung & Suche):**
  ...
  - → Posten `plan/posten/2026-09-24-des-der-guard-bund-passus-tolerant.md` (des/der-Guard Bund passus-tolerant)
  - → Posten `plan/posten/2026-09-24-kanton-luecken-hinweis-auch-im-prerenderten-html.md` (Kanton-Lücken-Hinweis auch im prerenderten HTML)
  - → Posten `plan/posten/2026-09-24-n-in-fremdgesetz-chapeau-items-verlinken.md` («§ N» in Fremdgesetz-Chapeau-Items verlinken)
...
**B · aus `W2·13-KANTONE-DATEN` (Daten & Extraktion):**
  ...
  - → Posten `plan/posten/2026-09-24-systematik-upstream-drift-ag-bs.md` (Systematik-Upstream-Drift AG/BS)
  - → Posten `plan/posten/2026-09-24-check-paritaet-ist-gegen-datei-loeschung-blind.md` (check:paritaet ist gegen Datei-LÖSCHUNG blind)
  ...
  - → Posten `plan/posten/2026-09-24-pdf-pfad-liest-ziffern-tarife-falsch.md` (PDF-Pfad liest Ziffern-Tarife falsch)
  - → Posten `plan/posten/2026-09-24-fassungs-drift-pdf-erfasster-snapshots-unbemerkt.md` (Fassungs-Drift PDF-erfasster Snapshots unbemerkt)
