...
| Ausbeute | **3 belastbar (~4 %)** — ein fehlender Grenzwert-Test (`dauerUeberDreiMonate`, Art. 324a OR) und zwei überholte Code-Kommentare; **0 gestartet**. Eingeordnet als ROADMAP-Schritt `QS-CODE-LFZ-GRENZE`. |
